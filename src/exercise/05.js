...
const callAll =
	(...fns) =>
	(...args) =>
		// because ORDER MATTERS in a function's params so that's why `fns` is treated as an array
...
function App() {
	...
	// notice this pattern is used for ADDING MORE || REPLACING FUNCTIONALITIES to an existing function
