# Latest Ref & Context Module Functions 

## 📝 What I've learnt
- [Implement](https://github.com/HelpMe-Pls/advanced-react-patterns/blob/extra/src/final/TS/01.tsx) (at the `useDebounce` hook) `useRef` and `useEffect` to get the latest `ref` (which was a default feature back when React was class-based). 
...
- Typing `setTimeout`: `let timer: ReturnType<typeof setTimeout> | null = null`
