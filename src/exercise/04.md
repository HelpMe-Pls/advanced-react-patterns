...
## 📝 What I've learnt
- Using `useRef` (at ` useToggle` definition from [04.tsx](https://github.com/HelpMe-Pls/advanced-react-patterns/blob/extra/src/final/TS/04.tsx)) to secure `initialState`
