...
function Toggle({children}: {children: React.ReactNode}) {
	...
	const value: ToggleValue = [on, toggle]
...
function ToggleOn({children}: {children: React.ReactNode}) {
	const [on] = React.useContext(ToggleContext)! // `!` is asserting that the value of that expression is definitely not undefined or null
